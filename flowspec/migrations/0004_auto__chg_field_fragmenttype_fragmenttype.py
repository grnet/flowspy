...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FragmentType.fragmenttype'
        db.alter_column('flowspec_fragmenttype', 'fragmenttype', self.gf('django.db.models.fields.CharField')(max_length=20))
    
    
    def backwards(self, orm):
        
        # Changing field 'FragmentType.fragmenttype'
        db.alter_column('flowspec_fragmenttype', 'fragmenttype', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True))
