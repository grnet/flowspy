...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Route.fragmenttype'
        db.delete_column(u'route', 'fragmenttype')

        # Adding M2M table for field fragmenttype on 'Route'
        db.create_table(u'route_fragmenttype', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('route', models.ForeignKey(orm['flowspec.route'], null=False)),
            ('fragmenttype', models.ForeignKey(orm['flowspec.fragmenttype'], null=False))
        ))
        db.create_unique(u'route_fragmenttype', ['route_id', 'fragmenttype_id'])
    
    
    def backwards(self, orm):
        
        # Adding field 'Route.fragmenttype'
        db.add_column(u'route', 'fragmenttype', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Removing M2M table for field fragmenttype on 'Route'
        db.delete_table('route_fragmenttype')
